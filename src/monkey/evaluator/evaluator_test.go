...
func TestBangOperator(t *testing.T) {
	tests := []struct {
		...
		{"!true", false},
		{"!false", true},
		{"!5", false}, // we're choosing to designate 5 as "truthy"
		{"!!true", true},
		{"!!false", false},
		{"!!5", true},
	}
...
// TODO: We need to allow functions to extend their environment for tests to pass
...
func TestArrayLiterals(t *testing.T) {
	...
	if len(result.Elements) != 3 {
		t.Fatalf("array has wrong number of arguments. got=%d",
			len(result.Elements))
	}
